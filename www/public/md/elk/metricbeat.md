...
```
cd ~/local
wget https://artifacts.elastic.co/downloads/beats/metricbeat/metricbeat-6.0.0-linux-x86_64.tar.gz
tar xvfz metricbeat-6.0.0-linux-x86_64.tar.gz
ln -s metricbeat-6.0.0-linux-x86_64 metricbeat
cd metricbeat
```
