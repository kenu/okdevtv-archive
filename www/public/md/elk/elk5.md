...
ln -s elasticsearch-5.5.2 elasticsearch
cd elasticsearch
bin/elasticsearch -d
...
tar xvfz kibana-5.5.2-linux-x86_64.tar.gz
ln -s kibana-5.5.2-linux-x86_64 kibana
cd kibana
```
...
tar xvfz logstash-5.5.2.tar.gz
...
tar xvfz filebeat-5.5.2-linux-x86_64.tar.gz
ln -s filebeat-5.5.2-linux-x86_64 filebeat
cd filebeat
