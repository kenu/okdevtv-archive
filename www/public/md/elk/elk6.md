...
tar xvfz elasticsearch-6.3.0.tar.gz
...
tar xvfz kibana-6.3.0-linux-x86_64.tar.gz
...
tar xvfz logstash-6.3.0.tar.gz
ln -s logstash-6.3.0 logstash
cd logstash
```
...
tar xvfz filebeat-6.3.0-linux-x86_64.tar.gz
ln -s filebeat-6.3.0-linux-x86_64 filebeat
cd filebeat
