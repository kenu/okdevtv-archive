...
```
참고 :`com.brunokrebs.webapp` 서비스 ID 및 TEAM_ID팀 ID의 식별자로 교체해야 합니다. 이 값을 찾으려면 [이 페이지를 방문하십시오.](https://developer.apple.com/account/#/membership) 또한 KEY_ID를 앞서 언급한 키 ID로 교체해야 합니다.
